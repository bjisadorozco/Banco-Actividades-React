...
function PreguntasSiNo() {
  ...
  return (
    <div className="flex flex-col mb-36 md:mb-0 w-full max-w-7xl mx-auto px-4">
      <div className="flex flex-col md:flex-row gap-4 lg:gap-8 w-full items-stretch">
        {/* Sección de imágenes - Izquierda */}
        <div className="md:flex-1 w-full md:w-1/2 flex">
          <div
                    ...
                    {questionResults[index] !== undefined &&
                      (questionResults[index] === 1 ? (
                        ...
                        <div className="error-section">
                          <img src={xmarkIcon} alt="Incorrecto" className="error-icon" />
        ...
        <div className="md:flex-1 bg-white w-full md:w-1/2 px-2 flex items-stretch bordeado">
          <div className="w-full flex flex-col justify-center">
            {showQuestions && !showResults && (
              <div className="preguntas_SN h-full">
                <div className="ctItem-SN h-full flex flex-col justify-between">
                  <div>
            ...
            {showResults && (
              <div className="results-container font-text texto-gray font-text h-full flex flex-col justify-between">
                <div>
                    ...
                    {(allCorrect || !allIncorrect) && (
                      <div className={`correct-answers ${allCorrect ? "full-width" : ""}`}>
                        <h3 className="preguntas_true font-bold flex items-center">
                          ...
                          <img className="w-6 m-0 ml-1" src={checkIcon} />
                        </h3>
                        <ul className="ml-4">
                          {questionResults.map(
                    ...
                    {(allIncorrect || !allCorrect) && (
                      <div className={`incorrect-answers ${allIncorrect ? "full-width" : ""}`}>
                        <h3 className="preguntas_false font-bold flex items-center">
                          ...
                          <img className="w-6 m-0 ml-1" src={xmarkIcon} />
                        </h3>
                        <ul className="ml-4">
                          {questionResults.map(
      ...
      {showResults && (
        <div className="mt-8 text-center container-feedbackPSN font-text w-full max-w-4xl mx-auto">
          <p
