...
function PreguntasRiesgosMecanicos() {
    ...
    const questions = [
        ...
        {
            question: "¿Qué situación puede generar golpes o fracturas en las manos de un trabajador?",
            options: [
                { text: "Uso incorrecto de una sierra circular.", correct: false },
                { text: "Caída accidental de una viga o herramienta pesada.", correct: true },
    ...
    const handleValidate = () => {
        if (selectedAnswers[currentQuestion]?.length > 0) {
            ...
            if (questions[currentQuestion].multipleCorrect) {
                ...
                isCorrect = selectedAnswers[currentQuestion].length === questions[currentQuestion].correctCount &&
            ...
            <div className="md:flex-2 bg-white md:w-full w-full px-2 md:pr-20 flex justify-center items-center pb-2 mt-12">
                <div className="w-full flex flex-col justify-center items-center">
                    ...
                    {showQuestions && !showResults && showFeedback && (
                        <div className="feedback-containerPRM ctItemPRM mt-4">
                            <Paragraph theme="light" justify={isMobile ? "justify" : "justify"}>
                                <strong
                                    style={{
                    ...
                    {showResults && (
                        <div className="resultado-containerPRM">
                            ...
                            <div className="results-list">
                                {questionResults.map((result, index) => (
                                    <p key={index} theme='light' className="text-centrar">
                                        ...
                                        <span className={result === 1 ? 'text-successPRM' : 'text-errorPRM'}>
                                            {result}/1
                                            {' '}respuestas correcta
                                        </span>
                                    </p>
                            ...
                            <p className="text-paragraph-light-color font-bold text-monserrat">Tus respuestas correctas son: {results.correct} de 2 ({results.percentage}%)</p>
                            <Button
                                bold={false}
                                icon={faRepeat}
                                roundedFull={true}
