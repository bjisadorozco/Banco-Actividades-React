...
export default function PPT_09_DragAndDrop() {
  ...
  const handleReset = useCallback(() => {
    ...
    setAvailableItems(["100 Kgs", "1000 Kgs", "500 Kgs"]);
  ...
  const handleValidation = useCallback(() => {
    ...
    const isCorrect =
      items.dropZone1 === correctAnswers.dropZone1 &&
      items.dropZone2 === correctAnswers.dropZone2 &&
      items.dropZone3 === correctAnswers.dropZone3;
          ...
          <div className="card-container">
            <div className={`card ${validationState.dropZone1}`}>
              <Paragraph theme="light">
                Exposición a posibles descargas eléctricas en contacto con
                cables o equipos defectuosos.
              </Paragraph>
              {validationState.dropZone1 && (
                <img
                  src={
                    validationState.dropZone1 === "validation-success"
                      ? checkIcon
                      : xmarkIcon
                  }
                  alt={
              ...
              {isMobile ? (
                <select
                  ...
                  onChange={(e) =>
                    handleSelectChange(e.target.value, "dropZone1")
                  }
            ...
            <div className={`card ${validationState.dropZone2}`}>
              ...
              {validationState.dropZone2 && (
                <img
                  src={
                    validationState.dropZone2 === "validation-success"
                      ? checkIcon
                      : xmarkIcon
                  }
                  alt={
              ...
              {isMobile ? (
                <select
                  ...
                  onChange={(e) =>
                    handleSelectChange(e.target.value, "dropZone2")
                  }
                  disabled={!!validationMessage}
                >
                  <option value="">Seleccione una opción...</option>
      ...
      <div className="action-container">
        <div className="action-buttons">
          ...
          <Button
            ...
            onClick={handleReset}
            disabled={
              !items.dropZone1 && !items.dropZone2 && !validationMessage
            }
          >
            Reiniciar
          </Button>
