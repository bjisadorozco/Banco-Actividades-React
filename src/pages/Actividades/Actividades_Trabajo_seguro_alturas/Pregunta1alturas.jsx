...
function Pregunta1alturas() {
    ...
    const question = {
        question: "Andy lo ve, y sabe que es riesgoso…¿Qué crees que Andy debe hacer?",
        options: [
            { text: "Ayudarle a subir a la estructura para que empiece rápido", correct: false },
            { text: "Detener la labor, y recordarle que una tarea de alto riesgo requiere ATS y permiso de trabajo", correct: true },
            { text: "Pasar de largo y no decir nada para que no regañen a Juan", correct: false }
        ],
        correctFeedback: "¡Muy bien! Tienes la actitud correcta para comenzar este curso de Trabajo seguro en alturas!",
        incorrectFeedback: " ¡Piénsalo bien! No vale la pena subir, ni tampoco quedarse callado."
    };
